...
// test('when matching uniqueness on a non-nested resource', function() {
  ...
  // equal(DS.Validations.validators.remote.uniqueness(model, property, options), undefined);
// });
...
// test('when matching uniqueness on a non-nested resource', function() {
  ...
  // equal(DS.Validations.validators.remote.uniqueness(model, property, options), "failed validation");
// });
...
// test('when matching local uniqueness for nested has-many resources', function() {
  ...
  // DS.Validations.forms['new_user_2'] = {
    // type: 'ActionView::Helpers::FormBuilder',
  ...
  // equal(DS.Validations.validators.remote.uniqueness(user_1_email, options), undefined);
  // equal(DS.Validations.validators.local.uniqueness(user_1_email, options), "must be unique");
// });
