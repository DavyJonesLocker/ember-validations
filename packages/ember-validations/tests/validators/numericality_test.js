...
test('when value is a number', function() {
  ...
  validator = Ember.Validations.validators.local.Numericality.create({property: 'attribute', options: options});
...
test('when value refers to another present property', function() {
  ...
  validator = Ember.Validations.validators.local.Numericality.create({property: 'attribute_1', options: options});
  validator.call(model, fail, pass);
