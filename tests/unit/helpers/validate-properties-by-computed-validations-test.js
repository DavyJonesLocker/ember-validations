...
moduleFor('controller:computed-foo', 'Unit - ComputedFoo Controller Test', {
  needs: [
...
moduleFor('controller:computed-foo', 'Unit - Ensure validate properties test helpers fail when invalid', {
  needs: [
    'ember-validations@validator:local/presence',
    'ember-validations@validator:local/length'
  ],
